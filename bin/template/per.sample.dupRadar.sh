...
Rscript /home/ssg29/Pipelines/bin/template/per.sample.dupRadar.R $SLX $Barcode ${My_bam%.bam}.dedup.bam $NT

echo -e "\e[32m$Barcode done for per.sample.dupRadar\e[0m"
