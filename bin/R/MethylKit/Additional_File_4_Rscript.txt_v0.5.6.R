...
#One important consideration in logistic regression is the sample size, 
#and in many biological experiments the number of biological samples in each group can be quite small.  
#However, it is important to keep in mind that the relevant sample sizes in logistic regression are not merely the number of biological samples
#but rather the total read coverages summed over all samples in each group separately. 