...
#SLX-8080.v1
project2<-'SLX-8080'
project_dir2<-paste0(top_result_dir,"/",project2,".v1") # /scratch/ssg29/results/SLX-8080.v1
bismark_call_dir2<-paste0(project_dir2,"/Bismark/MethylCall") # /scratch/ssg29/results/SLX-8080.v1/Bismark/MethylCall

#result
my_prefix="SLX-8074.SLX-8080.v1"
methylkit_dir<-paste0(top_result_dir,"/",my_prefix,"/MethylKit") # /scratch/ssg29/results/SLX-8074.SLX-8080.v1/MethylKit
...
# 1. reformat
#for i in A002 A004 A005 A007; do awk 'BEGIN{print "chrBase chr base strand coverage freqC freqT"}{str="F"}{if($3=="-"){str="R"}}{if($4+$5>0){cov=$4+$5;print $1"."$2,$1,$2,str,cov,$4/cov*100,$5/cov*100}}' results/SGA_v1/Bismark/MethylCall/$i/$i.r_1_val_1.fq.gz_bismark_bt2_pe.deduplicated.q20.CpG_report.txt > results/SGA_v1/Bismark/MethylCall/$i/$i.r_1_val_1.fq.gz_bismark_bt2_pe.deduplicated.q20.CpG_report.txt.methylkit.txt; done

#############################
## 1. Read methylation files
#############################
file.list=list( paste0(bismark_call_dir1,"/A001/",project1,".A001.r_1_val_1.fq.gz_bismark_bt2_pe.q1.deduplicated.CpG_report.methylkit.txt"),
				paste0(bismark_call_dir2,"/A001/",project2,".A001.r_1_val_1.fq.gz_bismark_bt2_pe.q1.deduplicated.CpG_report.methylkit.txt"))
				#paste0(bismark_call_dir1,"/A010/",project1,".A010.r_1_val_1.fq.gz_bismark_bt2_pe.q1.deduplicated.CpG_report.methylkit.txt"),
				#paste0(bismark_call_dir1,"/A003/",project1,".A003.r_1_val_1.fq.gz_bismark_bt2_pe.q1.deduplicated.CpG_report.methylkit.txt"))
...
myobj=read( file.list, sample.id=list(paste0(project1,".A001"),paste0(project2,".A001")),
			assembly="hg19",treatment=c(0,0),context="CpG") # is a 'methylRawList'
...
filtered.myobj=filterByCoverage(myobj,lo.count=5,lo.perc=NULL, hi.count=NULL,hi.perc=99.9) # is a 'methylRawList' 
...
# 
meth=unite(filtered.myobj,destrand=TRUE) # is a 'methylBase'
head(meth)
