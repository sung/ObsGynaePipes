...
do
	SAMPLES=${CASECTR/,/ } # D709_D501,D709_D502 => D709_D501 D709_D502 
...
de = glmLRT(f, coef=15) # column number for Condition in design data.frame (23 in our case, which is ConditionCTR)
